                        ...
                        <div className="flex-1 flex flex-col min-h-0 bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-2">
                          ...
                          <div className="flex-1 min-h-0 relative">
                            ...
                            {isPSSStyleSummary(normalizedSheetType) && (
                                <PSSSummaryTable data={editData.rows} setData={(newRows) => setEditData({ ...editData, rows: newRows })} onSave={() => {}} onSubmit={handleSaveEdit} isLocked={false} status={editingEntry.status} sheetType={normalizedSheetType} />
                            )}
