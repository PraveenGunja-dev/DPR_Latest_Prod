            ...
            for idx, a in enumerate(acts):
                ...
                await pool.execute("""
                    ...
                    ON CONFLICT (object_id) DO UPDATE SET
                        ...
                        percent_complete = EXCLUDED.percent_complete,
                        total_quantity = CASE WHEN EXCLUDED.total_quantity > 0 THEN EXCLUDED.total_quantity ELSE solar_activities.total_quantity END,
                        uom = CASE WHEN EXCLUDED.uom != '' AND EXCLUDED.uom IS NOT NULL THEN EXCLUDED.uom ELSE solar_activities.uom END,
                        balance = CASE WHEN EXCLUDED.total_quantity > 0 THEN EXCLUDED.balance ELSE solar_activities.balance END,
                        cumulative = CASE WHEN EXCLUDED.total_quantity > 0 THEN EXCLUDED.cumulative ELSE solar_activities.cumulative END,
                        last_sync_at = EXCLUDED.last_sync_at,
