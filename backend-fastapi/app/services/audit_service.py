...
# A sign-in or password step that skipped the OTP because OTP_BYPASS_UNTIL was open (SMTP outage).
...
SECURITY_ACTIONS = [
    ...
    OTP_FAILED, OTP_BYPASSED, RECOVERY_EMAIL_CHANGED, RECOVERY_EMAIL_VERIFIED, LOGIN_SUCCESS,
