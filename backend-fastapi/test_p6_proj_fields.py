...
async def test():
    ...
    async with get_http_client() as client:
        r = await client.get(f"{BASE_URL}/project?Filter=Name='Demo 25MW'&Fields=ObjectId,Id,Name,ActualStartDate,ActualFinishDate,StartDate,FinishDate", headers=headers)
